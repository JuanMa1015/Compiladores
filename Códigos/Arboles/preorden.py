...
class InterfazGrafica:
    ...
    def dibujar_arbol(self, nodo, x, y, distancia):
        ...
        radio = 20
        self.canvas.create_oval(x-radio, y-radio, x+radio, y+radio, fill="lightgreen")
    ...
    def dibujar_recorrido_preorden(self):
        ...
        for i in range(len(recorrido)-1):
            ...
            self.canvas.create_text((x1 + x2)//2, (y1 + y2)//2 - 10, text=str(i+1), fill="red", font=("Arial", 10, "bold"))

        if recorrido:
            print("Recorrido preorden:", recorrido)
